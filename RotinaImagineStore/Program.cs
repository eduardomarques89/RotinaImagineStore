...
namespace RotinaImagineStore
{
    internal class Program
    {
        ...
        public static void GETVendasfiltro()
        {
            ...
            while (page <= maxPage)
            {
                var request = new RestRequest($"/cashless_facts?access_token=04PJ5nF3VnLIfNLJRbqmZkEMhU2VNCClOjPoTPCI&start_date=2024-09-05&end_date=2024-09-10&page={page}&per_page={perPage}");
        ...
        public static void GETVendas()  
        {
            ...
            while (page <= maxPage)
            {
                var request = new RestRequest($"/cashless_facts?access_token=04PJ5nF3VnLIfNLJRbqmZkEMhU2VNCClOjPoTPCI&start_date=2024-09-15&end_date=2024-09-20&page={page}&per_page={perPage}");
